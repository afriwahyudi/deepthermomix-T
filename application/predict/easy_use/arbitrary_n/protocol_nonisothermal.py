...
# ==========================================
# Format: (smiles_list, target_idx, steps, temperature)
SYSTEMS = [
    (['CCO', 'O', 'c1ccccc1'], '0', '50', '313.15'),
    (['CCO', 'O', 'c1ccccc1'], '1', '50', '313.15'),
    (['CCO', 'O', 'c1ccccc1'], '2', '50', '313.15'),
]
...
for constraint_type, model_sub, out_sub in MODEL_CONFIGS:
    for smiles, target_idx, steps, temperature in SYSTEMS:
        cmd_args = [
            '--smiles',         *smiles,
