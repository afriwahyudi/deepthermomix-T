...
class DataPipeline:
    ...
    Two necessary files to be supplied:
        1. Component registry CSV
            - In this project, it is located in 'development/datasets/components.csv'
            - Structured in such a way -> ['solvent_name';'solvent_id';'smiles_can']
                ...
                - smiles_can        : The canonical SMILES strings
        ...
        2. Raw VLE data CSV
            - In this project, it is located in 'development/datasets'
    ...
    def construct_graphs(self, canonical_df: pd.DataFrame) -> List[Data]:
        ...
        for (idx, row), system_type in zip(canonical_df.iterrows(), system_types):
            ...
            graph_data = Data(
                ...
                temperature=torch.tensor(row['T'], dtype=torch.float),
